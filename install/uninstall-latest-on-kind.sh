kubectl delete -f ../deploy/operator.yaml -n microcks
kubectl delete -f ../deploy/role_binding.yaml -n microcks 
kubectl delete -f ../deploy/role.yaml -n microcks 
kubectl delete -f ../deploy/service_account.yaml -n microcks  
kubectl delete -f ../deploy/crds/microcks_v1alpha1_microcksinstall_crd.yaml -n microcks 
